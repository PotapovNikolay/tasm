...
Begin:	mov AX,data			;(3)Инициализация сегментного
		mov DS,AX			;(4)регистра DS ;Подготовим все необходимое для организации цикла
		mov CX,223			;(5)Число шагов в цикле
		mov SI,0			;(6)Индекс адресуемого элемента в заполняемом массиве
		mov AL,32			;(7)Код первого символа - пробела Теперь собственно цикл, в который входит 4 команды
fill:	mov symbols(SI),AL	;(8)Занесение очередного кода в байт массива с индексом SI
		...
		loop fill			;(11)Команда цикла из CX шагов Выведем для контроля полученный символьный массив на экран
		...
		int 21h			    ;(16)Вызов DOS Завершим программу
		mov AX,4C00h		;(17)
		int 21h			    ;(18)
text		ends			;(19)Конец сегмента команд
data		segment			;(20)Начало сегмента данных Поля данных программы
